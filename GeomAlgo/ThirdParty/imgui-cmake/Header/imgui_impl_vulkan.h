...
IMGUI_IMPL_API bool         ImGui_ImplVulkan_CreateFontsTexture(VkCommandBuffer command_buffer);//ne fonctionne pas 
IMGUI_IMPL_API void         ImGui_ImplVulkan_destroyFontsTexture();//ne fonctionne pas 
